...
public class XxlJobHelper {
    ...
    public static long getJobId() {
        return XxlJobContext.getXxlJobContext() == null ? -1 : XxlJobContext.getXxlJobContext().getJobId();
    }
    ...
    public static String getJobParam() {
        return XxlJobContext.getXxlJobContext() == null ? null : XxlJobContext.getXxlJobContext().getJobParam();
    }
    ...
    public static String getJobLogFileName() {
        return XxlJobContext.getXxlJobContext() == null ? null : XxlJobContext.getXxlJobContext().getJobLogFileName();
    }
    ...
    public static int getShardIndex() {
        return XxlJobContext.getXxlJobContext() == null ? -1 : XxlJobContext.getXxlJobContext().getShardIndex();
    }
    ...
    public static int getShardTotal() {
        return XxlJobContext.getXxlJobContext() == null ? -1 : XxlJobContext.getXxlJobContext().getShardTotal();
    }

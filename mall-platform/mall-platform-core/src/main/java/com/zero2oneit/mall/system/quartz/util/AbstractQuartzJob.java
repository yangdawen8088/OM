package com.zero2oneit.mall.system.quartz.util;

import com.zero2oneit.mall.common.utils.BeanUtils;
import com.zero2oneit.mall.common.utils.Constant;
...
public abstract class AbstractQuartzJob implements Job {
    ...
    protected void after(JobExecutionContext context, SysJob sysJob, Exception e) {
        ...
        if (e != null) {
            ...
            String errorMsg = StringUtils.getExceptionMsg(e);
            sysJobLog.setExceptionInfo(errorMsg);
        } else {
            sysJobLog.setStatus(Constant.SUCCESS);
        }
        // 写入数据库当中
        SpringUtils.getBean(QuartzMapper.class).addJobLog(sysJobLog);
    }

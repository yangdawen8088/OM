<template>
	<button class="tui-btn" :class="[
	 ...
	 :loading="loading" :open-type="openType" :form-type="openType"  @getuserinfo="bindgetuserinfo" :disabled="disabled" @tap="handleClick">
		<slot></slot>
	</button>
</template>
...
<style scoped lang="scss">
	...
	.tui-primary-outline::after {
		border: 1rpx solid $main-color !important;
	}
	...
	.tui-danger-outline::after {
		border: 1rpx solid #F22222 !important;
	}

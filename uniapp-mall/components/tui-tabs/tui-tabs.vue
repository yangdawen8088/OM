<template>
	<view class="tui-tabs-view" :class="[isFixed?'tui-tabs-fixed':'tui-tabs-relative',unlined?'tui-unlined':'']" :style="{height:height+'rpx',padding:`0 ${padding}rpx`,background:bgColor,top:isFixed?top+'rpx':'auto'}">
...
<style>
	...
	.tui-tabs-slider {
		...
		background-image: linear-gradient(90deg, #f22222 0%, rgba(242, 34, 34, 0.2) 100%);
	}
</style>
